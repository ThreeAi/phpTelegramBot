...
@section('content')
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <a href="{{route('settings.index')}}" class="btn btn-primary" role="button" data-bs-toggle="button">Back</a>
        <a href="{{route('settings.edit', $setting->id)}}" class="btn btn-warning" role="button" data-bs-toggle="button">Edit</a>
